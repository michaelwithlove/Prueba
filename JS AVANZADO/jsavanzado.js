...
const newArray = [...numerosImpares, ...numerosPares];
const [uno, ...dos] = newArray

console.log(uno)
console.log(dos) //uso de Op Rest para llamar al resto de elementos del array

//Intercambio de variables sin necesidad de una variable temporal**
let a = 1;
let b = 2;
